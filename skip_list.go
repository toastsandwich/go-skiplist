...
//
// P is the probability used when choosing random heights for new elements
// (see [NewSkipList]).
...
// Push inserts the key/value pair into the skip list.
